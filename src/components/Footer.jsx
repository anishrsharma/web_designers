          ...
          <div class="row" style={{display:'flex', justifyContent:'center'}}>
            ...
            <div class="col-md-4 col-sm-4" style={{width:'30%',padding:'20px'}}>
              <div class="widget" id="enquiry">
                <h3>Contact us</h3>
                <form id="form1" name="form1" method="post" action="pro_quickmail.php" onsubmit="return check();">
                  <div class="row" style={{display:'flex'}}>
                    <div class="col-md-6 col-sm-6">
                      <input type="text" class="name-field-1" name="txtName" id="txtName" placeholder="Name" required="" style={{color: 'black', backgroundColor: 'gainsboro'}}/>
                      </div>
                        <div class="col-md-6 col-sm-6">
                          <input type="email" class="name-field-3" name="email" id="email" placeholder="Email" required="" style={{color: 'black', backgroundColor: 'gainsboro'}}/>
                        </div>
                    </div>
                    <br/>
                      <div class="row" style={{display:'flex'}}>
                        <div class="col-md-6 col-sm-6">
                          <input type="tel" class="name-field-2" name="txtmob" id="txtmob" placeholder="Phone" required="" style={{color: 'black', backgroundColor: 'gainsboro'}}/>
                        </div>
                        <div class="col-md-6 col-sm-6">
                          <input type="text" class="name-field-1" name="txtmessage1" id="txtmessage1" placeholder="Budget" required="" style={{color: 'black', backgroundColor: 'gainsboro'}}/>
                        </div>
                      </div>
                      <br/>
                        <div class="row">
                          <div class="col-md-12 col-sm-12">
                            <textarea class="name-field-1" name="txtmessage" id="txtmessage" required="" placeholder="Enter your Requirement" rows="9" style={{color: 'black', backgroundColor: 'gainsboro', height: '60px', width: '92%'}}></textarea>
                          </div>
                        </div>
                        <p>
                        </p>
